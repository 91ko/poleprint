...
export default function MainTableGrid({
  ...
  const [columnDefs] = useState<ColDef<MainTableRow>[]>([
    ...
    { field: 'clientName', headerName: '거래처명', width: 180, editable: true },
    { field: 'remarks', headerName: '비고', width: 180, editable: true },
    {
      field: 'totalQty',
      headerName: '총수량',
      width: 85,
    ...
    { field: 'constructor', headerName: '시공자', width: 110, editable: true },
    { field: 'website', headerName: '홈페이지', width: 150, editable: true },
    { field: 'mgmt', headerName: '관리', width: 110, editable: true },
    { field: 'mgmt1', headerName: '관리1', width: 110, editable: true },
    { field: 'mgmt2', headerName: '관리2', width: 110, editable: true },
  ]);
